...
# create model
config = ModelArgs(n_layers=12, n_heads=12, dim=768, vocab_size=50304, max_seq_len=1024, n_kv_heads=4, intermediate_size=4*768)
model = LlamaTransformer(config)
model.to(device)
...
log_dir = f"log_{config.n_layers}_{config.n_heads}_{config.n_kv_heads}_{max_lr:.0e}"
